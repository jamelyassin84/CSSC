                    ...
                    <CandidateList
                        ...
                        center={
                            <>
                                ...
                                <Text style={{ fontSize: 14, color: 'gray' }}>{candidate.position} for {candidate.voter.department}</Text>
                                ...
                                <Text style={{ fontSize: 11, color: 'gray' }}>{candidate.voter.course} {candidate.voter.year} year</Text>
                            </>
                        }
